...
public:
	...
	void UpdateTargets ( vec3_t *pos, quaternion_t *q, matrix3x4_t *bone_cache, void *computed );
	void SolveDependencies ( vec3_t *pos, quaternion_t *q, matrix3x4_t *bone_cache, void *computed );
	void ClearTargets ( );
